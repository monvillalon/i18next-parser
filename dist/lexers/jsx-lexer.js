...
JsxLexer = function (_JavascriptLexer) {_inherits(JsxLexer, _JavascriptLexer);
  function JsxLexer() {var options = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};_classCallCheck(this, JsxLexer);
    ...
    var _this = _possibleConstructorReturn(this, (JsxLexer.__proto__ || Object.getPrototypeOf(JsxLexer)).call(this, options));_this.WalkerBase = Object.assign({}, _this.WalkerBase, _extends({},
    JSXParserExtension));


    try {
      var jsx = require('acorn-jsx');
      _this.parser = _this.parser.extend(jsx());
    } catch (e) {
      throw new Error(
